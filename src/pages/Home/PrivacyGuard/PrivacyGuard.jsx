...
const PrivacyGuard = () => {
    return (
        ...
        <div className="div">
          ...
          <h1 id="privacyguard" className=" text-[46px] sm:text-[60px] md:text-[80px] lg:text-[100px] text-center md:text-right md:mt-5 pb-10 md:pb-3 text-black opacity-25">Section 4</h1>
          </Fade>
