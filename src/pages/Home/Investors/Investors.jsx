...
const Investors = () => {
  ...
  return (
    <Fade>
    <div id="economics" className="relative mx-auto my-24 bg-[#F9FAFC] py-10 z-10">
      ...
      <h1 className="text-3xl z-10 w-full md:text-4xl lg:text-5xl md:leading-snug tracking-tighter font-black lg:leading-snug text-center text-[#181818] py-2">Investor Tokenomics</h1>
