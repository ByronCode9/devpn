...
const FirstMover = () => {
  ...
  <div className="relative w-full py-20">
     ...
     <div className="flex flex-col justify-between w-full z-50">
      <Fade direction="down">
      <h1 className="text-4xl z-10 lg:w-full md:text-3xl lg:text-5xl md:leading-snug tracking-tighter font-black lg:leading-snug text-center text-[#181818]">Our First-to-Market Innovations</h1>
      </Fade>
 </div>
